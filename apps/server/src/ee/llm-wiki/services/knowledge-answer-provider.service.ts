...
function buildSystemPrompt(
  ...
  return [
    ...
    `Timezone: ${timezone}.`,
    'First determine whether the available evidence directly supports an answer to the user question.',
    'Always begin with exactly one mode marker: [[answer:knowledge]] or [[answer:general]].',
    'Use [[answer:knowledge]] when the provided knowledge context, mentioned pages, current page context, or attachments directly support the answer.',
    ...
    'Do not use general world knowledge to fill missing factual claims in [[answer:knowledge]] mode.',
    'Use [[answer:general]] when the provided evidence is insufficient or unrelated.',
    'After [[answer:general]], ignore the knowledge context and answer directly from general model knowledge without workspace citations.',
